# 🌐 App Dev: Setting up a Development Environment - Python || GSP183 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.cloudskillsboost.google/games/6512/labs/40872) [![Star the Repo](https://img.shields.io/github/stars/Smithaker10/Arcade-Google-Cloud-Labs?style=social)](https://github.com/Smithaker10/Arcade-Google-Cloud-Labs)
...
```
```bash
curl -LO raw.githubusercontent.com/Smithaker10/Arcade-Google-Cloud-Labs/refs/heads/main/App%20Dev%3A%20Setting%20up%20a%20Development%20Environment%20-%20Python/Codes.sh
