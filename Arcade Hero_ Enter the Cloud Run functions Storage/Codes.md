# 🌐 Arcade Hero: Enter the Cloud Run functions Storage || GSP236 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.cloudskillsboost.google/games/6560/labs/41162) [![Star the Repo](https://img.shields.io/github/stars/Smithaker10/Arcade-Google-Cloud-Labs?style=social)](https://github.com/Smithaker10/Arcade-Google-Cloud-Labs)
...
```bash
curl -LO raw.githubusercontent.com/Smithaker10/Arcade-Google-Cloud-Labs/refs/heads/main/Arcade%20Hero%3A%20Enter%20the%20Cloud%20Run%20functions%20Storage/Codes.sh
