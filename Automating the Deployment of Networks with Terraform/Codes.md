# 🌐 Automating the Deployment of Networks with Terraform || GSP460 🚀 [![Open Lab](https://img.shields.io/badge/Open-Lab-blue?style=flat)](https://www.cloudskillsboost.google/games/6558/labs/41143) [![Star the Repo](https://img.shields.io/github/stars/Smithaker10/Arcade-Google-Cloud-Labs?style=social)](https://github.com/Smithaker10/Arcade-Google-Cloud-Labs)
...
```
```bash
curl -LO raw.githubusercontent.com/Smithaker10/Arcade-Google-Cloud-Labs/refs/heads/main/Automating%20the%20Deployment%20of%20Networks%20with%20Terraform/Codes.sh
